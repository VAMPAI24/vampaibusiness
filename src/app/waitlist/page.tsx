    ...
    return (
      <main className="bg-sec-100 min-h-screen max-h-screen overflow-hidden">
        ...
        <section className="h-screen flex items-center justify-center">
          <Container variant="flex">
            <div className="w-full flex flex-col items-center justify-center">
              <div className="w-full md:w-[75%] xl:w-[50%] text-center flex flex-col gap-[1em] items-center mx-auto">
                <h1 className="font-rubik font-bold text-[1.5em] md:text-[2em] text-sec-900 leading-[1.2em]">
                  An Account Manager Has Been Assigned to You
                </h1>
                <p className="font-jakarta text-sec-901 text-sm md:text-base">
                  Meet Temitayo Johnson-Laleye, your dedicated account manager.
                  Temitayo is just an email away to make your hiring process
                  smooth and efficient.
                </p>
              ...
              <p
                onClick={initMail}
                className="text-sm md:text-base inline text-center mt-[2em] italic text-main-800 cursor-pointer"
              >
                <strong className="text-main-901 !no-underline">
                  {" "}Contact Temitayo at:{" "}
                </strong>
                    ...
                    return (
                      <form onSubmit={handleSubmit} className="flex flex-col gap-[1em]">
                        ...
                        <Textfield
                          ...
                          placeholder="johndoe@gmail.com"
                          value={values.company_email}
                          error={errors.company_email && touched.company_email ? errors.company_email : ""}
                          onChange={(e) => {
                            handleChange(e);
                            handleInput(e);
                          }}
