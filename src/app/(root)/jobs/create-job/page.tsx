...
import { JobDataPreview } from "@/containers/create-job/job-preview";
...
const JobPosting = () => {
  ...
  const [currentView, setCurrentView] = useState("createJob");
        ...
        return (
          <div className="">
            ...
            <JobDataPreview
              ...
              changeTabFn={setCurrentTab}
              changeViewFn={setCurrentView}
            />
