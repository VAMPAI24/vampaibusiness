  ...
  return (
    <Container>
      ...
      <div className="mt-[5em]">
        {/* Mobile view: Flexbox with horizontal scrolling */}
        <div className="flex sm:hidden overflow-x-scroll w-full space-x-5">
          {HeroData.map((card, index) => (
            <div key={index} className="mt-2 min-w-[80%] sm:min-w-0">
        ...
        <div className="hidden sm:grid place-items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-center justify-center gap-5">
          {HeroData.map((card, index) => (
